...
describe("validateSubject", () => {
  ...
  // The allowlist keeps the device-local .env portable across readers and rejects controls and
  // shell metacharacters instead of relying on an incomplete blocklist.
