...
/** Empty every persisted Collie snapshot/mirror for this exact node origin. */
...
/** Test alias retained so existing focused cache tests stay explicit about their seam. */
export const __clearLastSeen = clearLastSeen;
