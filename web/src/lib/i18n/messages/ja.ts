...
export const ja: Dictionary = {
  ...
  "fleet.navigation.expand": "{name} を展開",
  "fleet.navigation.collapse": "{name} を折りたたむ",
  "fleet.navigation.openHierarchy": "Herds を開く",
  "fleet.navigation.resizeHierarchy": "Herds サイドバーの幅を変更",
  "fleet.navigation.resizeAgents": "エージェントサイドバーの幅を変更",
  "fleet.navigation.close": "ナビゲーションを閉じる",
  "fleet.command.bar.label": "Fleet コマンド",
  "fleet.command.bar.dismiss": "コマンドバーを閉じる",
  "fleet.command.bar.commandPlaceholder": "コマンドを検索",
  "fleet.command.bar.panePlaceholder": "ペインへ移動",
  "fleet.command.bar.empty": "一致するものがありません。",
  "fleet.command.bar.noBinding": "未割り当て",
  "fleet.command.bar.unavailable": "ここでは使えません",
  "fleet.command.bar.hint": "/ で始めるとコマンド、それ以外はペインを検索します。",
  "fleet.command.section.shell": "シェル",
  "fleet.command.hints.waiting": "次のキーを待っています…",
  "fleet.command.hints.more": "他に {count} 件",
  "fleet.command.scope.global": "全体",
  "fleet.command.scope.space": "Space",
  "fleet.command.scope.tab": "タブ",
  "fleet.command.scope.pane": "ペイン",
  "fleet.command.scope.navigation": "移動",
  "fleet.command.mic.absent": "このデバイスで使えるマイクがありません。",
  "fleet.command.mic.locked": "入力欄は現在入力を受け付けていません。",
  "fleet.command.mic.direct": "ターミナル直接入力が有効です。先に解除してください。",
  "fleet.command.mic.sending": "メッセージをまだ送信中です。",
  "fleet.command.mic.transcribing": "直前のクリップをまだ文字起こし中です。",
  "fleet.command.mic.alreadyRecording": "マイクはすでに録音中です。",
  "fleet.command.mic.notRecording": "マイクは録音していません。",
  "fleet.command.unavailable": "{name} はここでは使えません。",
  "fleet.command.failed": "{name} は完了しませんでした。",
  "fleet.rename.tab": "タブの名前を変更",
  "fleet.rename.pane": "ペインの名前を変更",
  "fleet.rename.blank": "タブには名前が必要です。",
  "fleet.rename.hint": "Enter で保存 · Esc で取消",
  "fleet.confirm.prompt": "y/N",
  "fleet.confirm.hint": "Enter で確定 · 他の入力はすべて取消",
  "fleet.confirm.closeTab": "タブ「{name}」を閉じますか？",
  "fleet.confirm.closeTabCost": "その中のペインはすべて終了します。",
  "fleet.confirm.closePane": "ペイン「{name}」を閉じますか？",
  "fleet.confirm.closePaneCost": "そのターミナルは終了します。",
  "fleet.confirm.failed": "閉じられませんでした。",
  "fleet.settings.title": "Fleet",
  "fleet.settings.description": "このフォークが追加する設定です。Collie 自身の設定は下に続きます。",
  "fleet.settings.scope.browser": "このブラウザ",
  "fleet.settings.scope.install": "このインストール",
  "fleet.settings.surface.title": "ペインの表示",
  "fleet.settings.surface.description": "すべてのペインを Collie のミラーとして描画するか、ミラー元のターミナルとして描画します。",
  "fleet.settings.surface.label": "ペインの描画",
  "fleet.settings.surface.mirror": "ミラー",
  "fleet.settings.surface.terminal": "ターミナル",
  "fleet.settings.shortcuts.title": "キーボードコマンド",
  "fleet.settings.shortcuts.description": "割り当てのドキュメント（JSON）。保存時に全体を検証します。",
  "fleet.settings.shortcuts.save": "保存",
  "fleet.settings.shortcuts.saving": "保存中…",
  "fleet.settings.shortcuts.saved": "保存しました。",
  "fleet.settings.shortcuts.conflict": "ファイルがディスク上で変更されました。現在の内容を上に表示しています。",
  "fleet.settings.shortcuts.unavailable": "このインストールは設定ドキュメントを提供していません。",
  "fleet.settings.shortcuts.risky": "ブラウザ依存: {bindings}",
  "fleet.settings.shortcuts.reference": "コマンド id と有効な割り当て",
