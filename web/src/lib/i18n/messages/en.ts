...
export const en = {
  ...
  "fleet.navigation.expand": "Expand {name}",
  "fleet.navigation.collapse": "Collapse {name}",
  "fleet.navigation.openHierarchy": "Open Herds",
  ...
  "fleet.command.hints.waiting": "waiting for the next key…",
  "fleet.command.hints.more": "+{count} more",
  "fleet.command.scope.global": "Anywhere",
  "fleet.command.scope.space": "Space",
  "fleet.command.scope.tab": "Tab",
  "fleet.command.scope.pane": "Pane",
  "fleet.command.scope.navigation": "Go to",
  "fleet.command.mic.absent": "This device has no microphone available.",
  "fleet.command.mic.locked": "The composer is not accepting input right now.",
  "fleet.command.mic.direct": "Type-into-terminal is armed; turn it off first.",
  "fleet.command.mic.sending": "A message is still being sent.",
  "fleet.command.mic.transcribing": "The last clip is still being transcribed.",
  "fleet.command.mic.alreadyRecording": "The microphone is already recording.",
  "fleet.command.mic.notRecording": "The microphone is not recording.",
  "fleet.command.unavailable": "{name} is not available here.",
  "fleet.command.failed": "{name} did not complete.",
  "fleet.rename.tab": "Rename tab",
  "fleet.rename.pane": "Rename pane",
  "fleet.rename.blank": "A tab needs a name.",
  "fleet.rename.hint": "Enter to save · Esc to cancel",
  "fleet.confirm.prompt": "y/N",
  "fleet.confirm.hint": "Enter to confirm · anything else cancels",
  "fleet.confirm.closeTab": "Close tab “{name}”?",
  "fleet.confirm.closeTabCost": "Every pane in it is killed.",
  "fleet.confirm.closePane": "Close pane “{name}”?",
  "fleet.confirm.closePaneCost": "Its terminal is killed.",
  "fleet.confirm.failed": "That could not be closed.",
  ...
  "fleet.settings.surface.title": "Pane surface",
  "fleet.settings.surface.description": "Draw every Pane as Collie's mirror, or as the terminal it mirrors.",
  "fleet.settings.surface.label": "Draw a Pane as",
  "fleet.settings.surface.mirror": "Mirror",
  "fleet.settings.surface.terminal": "Terminal",
