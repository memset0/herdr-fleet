...
export const ko: Dictionary = {
  ...
  "fleet.navigation.expand": "{name} 펼치기",
  "fleet.navigation.collapse": "{name} 접기",
  "fleet.navigation.openHierarchy": "Herds 열기",
  "fleet.navigation.resizeHierarchy": "Herds 사이드바 너비 조절",
  "fleet.navigation.resizeAgents": "에이전트 사이드바 너비 조절",
  "fleet.navigation.close": "탐색 닫기",
  "fleet.command.bar.label": "Fleet 명령",
  "fleet.command.bar.dismiss": "명령 바 닫기",
  "fleet.command.bar.commandPlaceholder": "명령 검색",
  "fleet.command.bar.panePlaceholder": "페인으로 이동",
  "fleet.command.bar.empty": "일치하는 항목이 없습니다.",
  "fleet.command.bar.noBinding": "단축키 없음",
  "fleet.command.bar.unavailable": "여기서는 사용할 수 없음",
  "fleet.command.bar.hint": "/ 로 시작하면 명령, 그 외에는 페인을 찾습니다.",
  "fleet.command.section.shell": "셸",
  "fleet.command.hints.waiting": "다음 키를 기다리는 중…",
  "fleet.command.hints.more": "그 외 {count}개",
  "fleet.command.scope.global": "전역",
  "fleet.command.scope.space": "Space",
  "fleet.command.scope.tab": "탭",
  "fleet.command.scope.pane": "페인",
  "fleet.command.scope.navigation": "이동",
  "fleet.command.mic.absent": "이 기기에서 사용할 수 있는 마이크가 없습니다.",
  "fleet.command.mic.locked": "입력란이 지금은 입력을 받지 않습니다.",
  "fleet.command.mic.direct": "터미널 직접 입력이 켜져 있습니다. 먼저 꺼 주세요.",
  "fleet.command.mic.sending": "메시지를 아직 보내는 중입니다.",
  "fleet.command.mic.transcribing": "마지막 클립을 아직 변환하는 중입니다.",
  "fleet.command.mic.alreadyRecording": "마이크가 이미 녹음 중입니다.",
  "fleet.command.mic.notRecording": "마이크가 녹음 중이 아닙니다.",
  "fleet.command.unavailable": "{name} 은(는) 여기서 사용할 수 없습니다.",
  "fleet.command.failed": "{name} 이(가) 완료되지 않았습니다.",
  "fleet.rename.tab": "탭 이름 변경",
  "fleet.rename.pane": "페인 이름 변경",
  "fleet.rename.blank": "탭에는 이름이 필요합니다.",
  "fleet.rename.hint": "Enter 저장 · Esc 취소",
  "fleet.confirm.prompt": "y/N",
  "fleet.confirm.hint": "Enter로 확인 · 다른 입력은 모두 취소",
  "fleet.confirm.closeTab": "탭 “{name}”을(를) 닫을까요?",
  "fleet.confirm.closeTabCost": "그 안의 모든 페인이 종료됩니다.",
  "fleet.confirm.closePane": "페인 “{name}”을(를) 닫을까요?",
  "fleet.confirm.closePaneCost": "해당 터미널이 종료됩니다.",
  "fleet.confirm.failed": "닫지 못했습니다.",
  "fleet.settings.title": "Fleet",
  "fleet.settings.description": "이 포크가 추가하는 설정입니다. Collie 자체 설정은 아래에 이어집니다.",
  "fleet.settings.scope.browser": "이 브라우저",
  "fleet.settings.scope.install": "이 설치본",
  "fleet.settings.surface.title": "페인 표시",
  "fleet.settings.surface.description": "모든 페인을 Collie의 미러로 그릴지, 미러 대상 터미널로 그릴지 선택합니다.",
  "fleet.settings.surface.label": "페인 표시 방식",
  "fleet.settings.surface.mirror": "미러",
  "fleet.settings.surface.terminal": "터미널",
  "fleet.settings.shortcuts.title": "키보드 명령",
  "fleet.settings.shortcuts.description": "단축키 문서(JSON). 저장 시 전체를 검증합니다.",
  "fleet.settings.shortcuts.save": "저장",
  "fleet.settings.shortcuts.saving": "저장 중…",
  "fleet.settings.shortcuts.saved": "저장했습니다.",
  "fleet.settings.shortcuts.conflict": "디스크에서 파일이 변경되었습니다. 현재 내용을 위에 표시합니다.",
  "fleet.settings.shortcuts.unavailable": "이 설치본은 설정 문서를 제공하지 않습니다.",
  "fleet.settings.shortcuts.risky": "브라우저에 따라 다름: {bindings}",
  "fleet.settings.shortcuts.reference": "명령 id와 유효한 단축키",
