...
export const es: Dictionary = {
  ...
  "fleet.navigation.expand": "Expandir {name}",
  "fleet.navigation.collapse": "Contraer {name}",
  "fleet.navigation.openHierarchy": "Abrir Herds",
  "fleet.navigation.resizeHierarchy": "Cambiar el ancho de la barra de Herds",
  ...
  "fleet.command.bar.dismiss": "Cerrar la barra de comandos",
  "fleet.command.bar.commandPlaceholder": "Buscar comandos",
  "fleet.command.bar.panePlaceholder": "Ir a un panel",
  "fleet.command.bar.empty": "Nada coincide.",
  "fleet.command.bar.noBinding": "Sin atajo",
  "fleet.command.bar.unavailable": "no disponible aquí",
  "fleet.command.bar.hint": "Empieza con / para comandos; cualquier otra cosa busca un panel.",
  "fleet.command.section.shell": "Shell",
  "fleet.command.hints.waiting": "esperando la siguiente tecla…",
  "fleet.command.hints.more": "+{count} más",
  "fleet.command.scope.global": "En todas partes",
  "fleet.command.scope.space": "Space",
  "fleet.command.scope.tab": "Tab",
  "fleet.command.scope.pane": "Panel",
  "fleet.command.scope.navigation": "Ir a",
  "fleet.command.mic.absent": "Este dispositivo no tiene micrófono disponible.",
  "fleet.command.mic.locked": "El campo de texto no acepta entradas ahora mismo.",
  "fleet.command.mic.direct": "La escritura directa en el terminal está activada; desactívala primero.",
  "fleet.command.mic.sending": "Todavía se está enviando un mensaje.",
  "fleet.command.mic.transcribing": "El último clip todavía se está transcribiendo.",
  "fleet.command.mic.alreadyRecording": "El micrófono ya está grabando.",
  "fleet.command.mic.notRecording": "El micrófono no está grabando.",
  "fleet.command.unavailable": "{name} no está disponible aquí.",
  "fleet.command.failed": "{name} no se completó.",
  "fleet.rename.tab": "Renombrar pestaña",
  "fleet.rename.pane": "Renombrar panel",
  "fleet.rename.blank": "Una pestaña necesita un nombre.",
  "fleet.rename.hint": "Enter para guardar · Esc para cancelar",
  "fleet.confirm.prompt": "y/N",
  "fleet.confirm.hint": "Enter confirma · cualquier otra cosa cancela",
  "fleet.confirm.closeTab": "¿Cerrar la pestaña «{name}»?",
  "fleet.confirm.closeTabCost": "Se termina cada panel que contiene.",
  "fleet.confirm.closePane": "¿Cerrar el panel «{name}»?",
  "fleet.confirm.closePaneCost": "Se termina su terminal.",
  "fleet.confirm.failed": "No se pudo cerrar.",
  "fleet.settings.title": "Fleet",
  "fleet.settings.description": "Lo que añade este fork. Los ajustes propios de Collie siguen debajo.",
  "fleet.settings.scope.browser": "Este navegador",
  "fleet.settings.scope.install": "Esta instalación",
  "fleet.settings.surface.title": "Superficie del panel",
  "fleet.settings.surface.description": "Dibujar cada panel como el espejo de Collie o como el terminal que refleja.",
  "fleet.settings.surface.label": "Dibujar un panel como",
  "fleet.settings.surface.mirror": "Espejo",
  "fleet.settings.surface.terminal": "Terminal",
  "fleet.settings.shortcuts.title": "Comandos de teclado",
  "fleet.settings.shortcuts.description": "El documento de atajos, en JSON. Al guardar se valida entero.",
  "fleet.settings.shortcuts.save": "Guardar",
  "fleet.settings.shortcuts.saving": "Guardando…",
  "fleet.settings.shortcuts.saved": "Guardado.",
  "fleet.settings.shortcuts.conflict": "El archivo cambió en disco. Arriba se muestra su contenido actual.",
  "fleet.settings.shortcuts.unavailable": "Esta instalación no sirve ningún documento de ajustes.",
  "fleet.settings.shortcuts.risky": "Depende del navegador: {bindings}",
  "fleet.settings.shortcuts.reference": "Ids de comando y sus atajos efectivos",
