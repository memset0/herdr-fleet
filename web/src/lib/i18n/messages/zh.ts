...
export const zh: Dictionary = {
  ...
  "fleet.navigation.hierarchy": "空间",
  "fleet.navigation.agents": "智能体",
  "fleet.navigation.empty": "暂无可用空间。",
  "fleet.navigation.expandSpace": "展开{name}",
  "fleet.navigation.collapseSpace": "折叠{name}",
  "fleet.navigation.expandHierarchy": "展开空间侧栏",
  "fleet.navigation.collapseHierarchy": "折叠空间侧栏",
  "fleet.navigation.expandAgents": "展开智能体侧栏",
  "fleet.navigation.collapseAgents": "折叠智能体侧栏",
  "fleet.navigation.resizeHierarchy": "调整空间侧栏宽度",
