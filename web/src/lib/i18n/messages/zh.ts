...
export const zh: Dictionary = {
  ...
  "fleet.navigation.expand": "展开{name}",
  "fleet.navigation.collapse": "折叠{name}",
  "fleet.navigation.openHierarchy": "打开 Herds",
  "fleet.navigation.resizeHierarchy": "调整 Herds 侧栏宽度",
  "fleet.navigation.resizeAgents": "调整智能体侧栏宽度",
  "fleet.navigation.close": "关闭导航",
  "fleet.command.bar.label": "Fleet 命令",
  "fleet.command.bar.dismiss": "关闭命令面板",
  "fleet.command.bar.commandPlaceholder": "搜索命令",
  "fleet.command.bar.panePlaceholder": "跳转到窗格",
  "fleet.command.bar.empty": "没有匹配项。",
  "fleet.command.bar.noBinding": "未绑定",
  "fleet.command.bar.unavailable": "此处不可用",
  "fleet.command.bar.hint": "以 / 开头搜索命令，否则查找窗格。",
  "fleet.command.section.shell": "Shell",
  "fleet.command.hints.waiting": "等待下一个键…",
  "fleet.command.hints.more": "另有 {count} 项",
  "fleet.command.scope.global": "全局",
  "fleet.command.scope.space": "Space",
  "fleet.command.scope.tab": "Tab",
  "fleet.command.scope.pane": "窗格",
  "fleet.command.scope.navigation": "跳转",
  "fleet.command.mic.absent": "此设备没有可用的麦克风。",
  "fleet.command.mic.locked": "输入框当前不接受输入。",
  "fleet.command.mic.direct": "已开启直接输入终端模式，请先关闭。",
  "fleet.command.mic.sending": "还有一条消息正在发送。",
  "fleet.command.mic.transcribing": "上一段录音还在转写中。",
  "fleet.command.mic.alreadyRecording": "麦克风已在录音。",
  "fleet.command.mic.notRecording": "麦克风当前没有在录音。",
  "fleet.command.unavailable": "{name} 在此处不可用。",
  "fleet.command.failed": "{name} 未能完成。",
  "fleet.rename.tab": "重命名 Tab",
  "fleet.rename.pane": "重命名窗格",
  "fleet.rename.blank": "Tab 必须有名字。",
  "fleet.rename.hint": "回车保存 · Esc 取消",
  "fleet.confirm.prompt": "y/N",
  "fleet.confirm.hint": "回车确认 · 输入其他任何内容即取消",
  "fleet.confirm.closeTab": "关闭 Tab「{name}」？",
  "fleet.confirm.closeTabCost": "其中每一个窗格都会被终止。",
  "fleet.confirm.closePane": "关闭窗格「{name}」？",
  "fleet.confirm.closePaneCost": "它的终端会被终止。",
  "fleet.confirm.failed": "无法关闭。",
  "fleet.settings.title": "Fleet",
  "fleet.settings.description": "本分支新增的设置。Collie 自身的设置在下方。",
  "fleet.settings.scope.browser": "本浏览器",
  "fleet.settings.scope.install": "本安装",
  "fleet.settings.surface.title": "面板呈现",
  "fleet.settings.surface.description": "把每个面板画成 Collie 的镜像，或画成它所镜像的终端。",
  "fleet.settings.surface.label": "面板画成",
  "fleet.settings.surface.mirror": "镜像",
  "fleet.settings.surface.terminal": "终端",
  "fleet.settings.shortcuts.title": "键盘命令",
  "fleet.settings.shortcuts.description": "绑定文档，JSON 格式。保存时整份校验。",
  "fleet.settings.shortcuts.save": "保存",
  "fleet.settings.shortcuts.saving": "保存中…",
  "fleet.settings.shortcuts.saved": "已保存。",
  "fleet.settings.shortcuts.conflict": "文件在磁盘上已被改动，上方显示的是它当前的内容。",
  "fleet.settings.shortcuts.unavailable": "本安装未提供设置文档。",
  "fleet.settings.shortcuts.risky": "因浏览器而异：{bindings}",
  "fleet.settings.shortcuts.reference": "命令 id 及其生效绑定",
