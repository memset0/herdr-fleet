...
export const de: Dictionary = {
  ...
  "fleet.command.bar.dismiss": "Befehlsleiste schließen",
  "fleet.command.bar.commandPlaceholder": "Befehle suchen",
  "fleet.command.bar.panePlaceholder": "Zu einem Pane springen",
  "fleet.command.bar.empty": "Keine Treffer.",
  "fleet.command.bar.noBinding": "Keine Belegung",
  "fleet.command.bar.unavailable": "hier nicht verfügbar",
  "fleet.command.bar.hint": "Mit / beginnen für Befehle, sonst wird ein Pane gesucht.",
  "fleet.command.section.shell": "Shell",
  "fleet.command.hints.waiting": "wartet auf die nächste Taste…",
  "fleet.command.hints.more": "+{count} weitere",
  "fleet.command.scope.global": "Überall",
  "fleet.command.scope.space": "Space",
  "fleet.command.scope.tab": "Tab",
  "fleet.command.scope.pane": "Pane",
  "fleet.command.scope.navigation": "Gehe zu",
  "fleet.command.mic.absent": "Auf diesem Gerät ist kein Mikrofon verfügbar.",
  "fleet.command.mic.locked": "Das Eingabefeld nimmt derzeit keine Eingaben an.",
  "fleet.command.mic.direct": "Direkteingabe ins Terminal ist aktiv; schalte sie zuerst aus.",
  "fleet.command.mic.sending": "Eine Nachricht wird noch gesendet.",
  "fleet.command.mic.transcribing": "Der letzte Clip wird noch transkribiert.",
  "fleet.command.mic.alreadyRecording": "Das Mikrofon nimmt bereits auf.",
  "fleet.command.mic.notRecording": "Das Mikrofon nimmt nicht auf.",
  "fleet.command.unavailable": "{name} ist hier nicht verfügbar.",
  "fleet.command.failed": "{name} wurde nicht abgeschlossen.",
  "fleet.rename.tab": "Tab umbenennen",
  "fleet.rename.pane": "Pane umbenennen",
  "fleet.rename.blank": "Ein Tab braucht einen Namen.",
  "fleet.rename.hint": "Enter zum Speichern · Esc zum Abbrechen",
  "fleet.confirm.prompt": "y/N",
  "fleet.confirm.hint": "Enter bestätigt · alles andere bricht ab",
  "fleet.confirm.closeTab": "Tab „{name}“ schließen?",
  "fleet.confirm.closeTabCost": "Jedes Pane darin wird beendet.",
  "fleet.confirm.closePane": "Pane „{name}“ schließen?",
  "fleet.confirm.closePaneCost": "Sein Terminal wird beendet.",
  "fleet.confirm.failed": "Das konnte nicht geschlossen werden.",
  "fleet.settings.title": "Fleet",
  "fleet.settings.description": "Was dieser Fork ergänzt. Collies eigene Einstellungen folgen darunter.",
  "fleet.settings.scope.browser": "Dieser Browser",
  "fleet.settings.scope.install": "Diese Installation",
  "fleet.settings.surface.title": "Pane-Ansicht",
  "fleet.settings.surface.description": "Jedes Pane als Collies Spiegel zeichnen oder als das Terminal, das es spiegelt.",
  "fleet.settings.surface.label": "Pane zeichnen als",
  "fleet.settings.surface.mirror": "Spiegel",
  "fleet.settings.surface.terminal": "Terminal",
  "fleet.settings.shortcuts.title": "Tastaturbefehle",
  "fleet.settings.shortcuts.description": "Das Belegungsdokument als JSON. Beim Speichern wird es als Ganzes geprüft.",
  "fleet.settings.shortcuts.save": "Speichern",
  "fleet.settings.shortcuts.saving": "Wird gespeichert…",
  "fleet.settings.shortcuts.saved": "Gespeichert.",
  "fleet.settings.shortcuts.conflict": "Die Datei wurde auf der Festplatte geändert. Oben steht ihr aktueller Inhalt.",
  "fleet.settings.shortcuts.unavailable": "Diese Installation liefert kein Einstellungsdokument.",
  "fleet.settings.shortcuts.risky": "Browserabhängig: {bindings}",
  "fleet.settings.shortcuts.reference": "Befehls-IDs und ihre wirksamen Belegungen",
  ...
  "connection.host.slowLink": "langsame Verbindung",
