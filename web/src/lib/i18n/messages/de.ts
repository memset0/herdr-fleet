...
export const de: Dictionary = {
  ...
  "fleet.navigation.expand": "{name} ausklappen",
  "fleet.navigation.collapse": "{name} einklappen",
  "fleet.navigation.openHierarchy": "Herds öffnen",
  "fleet.navigation.resizeHierarchy": "Breite der Herds-Seitenleiste ändern",
